...
namespace ObjectSmashingGame
{
	...
	public class OSGGameController : MonoBehaviour 
	{
        ...
        IEnumerator GameOver(float delay)
		{
            ...
            if ( gameOverCanvas )    
			{
                ...
                gameOverCanvas.Find("Base/TextScore").GetComponent<Text>().text = "SCORE " + finalScore.ToString();
    ...
    //            if ( score > highScore )    
                ...
                if (finalScore > highScore)
                {
                    ...
                    PlayerPrefs.SetInt(SceneManager.GetActiveScene().name + "HighScore", finalScore);
#else
